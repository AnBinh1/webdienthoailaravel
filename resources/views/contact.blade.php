...
<body>
	    		...
	    		<div class="col-sm-12">    			   			
					...
					<div id="gmap" class="contact-map">
                         <iframe class="position-relative rounded w-100 h-100"
                                    ...
                                    frameborder="0" style="width:100%; height: 385px; border:0;" allowfullscreen="" aria-hidden="false"
                                    tabindex="0"></iframe>
					</div>
				</div>			 		
			</div>    	
  ...
  <div class="contact-form">
   ...
   <form id="main-contact-form" class="contact-form row" name="contact-form" method="POST" action="{{ route('contact.send') }}">
    @csrf
    ...
    <div class="form-group col-md-12">
        <textarea name="message" class="form-control" required rows="8" placeholder="Your Message Here">{{ old('message') }}</textarea>
    </div>
