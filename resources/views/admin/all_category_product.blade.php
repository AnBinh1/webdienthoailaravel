          ...
          <tbody>
            @foreach ($all_category_product as $key=> $cate_pro)
              <tr>
                ...
                <td>
                  <a href="{{URL::to('/edit_category_product/'. $cate_pro->category_id)}}" class="btn btn-sm btn-warning">sửa</a>
                  <a onclick="return confirm('Are you sure to delete')" href="{{URL::to('/delete_category_product/'. $cate_pro->category_id)}}" class="btn btn-sm btn-danger">xoá</a>
                </td>
              </tr>
            @endforeach
