			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/danh_muc_san_pham/'.$category_product->category_id)}}">{{ $category_product->category_name }}</a></h4>
								</div>
							</div>
							@endforeach
						...
						<div class="panel-group category-products" > <!--brands_products-->
							
							@foreach ($brand as $key => $brand_product )
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/thuong_hieu_san_pham/'.$brand_product->brand_id)}}">{{ $brand_product->brand_name }}</a></h4>
								</div>
							</div>
							@endforeach
						</div><!--/brands_products-->
					...
					<div class="col-sm-7">
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('fontendimages/home/iframe4.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
